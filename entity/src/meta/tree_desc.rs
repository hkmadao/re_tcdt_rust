...
pub fn get_tree_desc() ->  EntityDesc {
    let entity_info = EntityInfo {
        name: "Tree".to_owned(),
        display_name: "树".to_owned(),
        class_name: "Tree".to_owned(),
        table_name: "ui_tree".to_owned(),
        base_path: "entity::tree".to_owned(),
    };
    let id_tree_attribute_info = AttributeInfo {
        column_name: "id_tree".to_owned(),
        name: "idTree".to_owned(),
    ...
    let entity_desc = EntityDesc {
      ...
      pk_attribute_info: id_tree_attribute_info.clone(),
      ...
      attribute_info_map: HashMap::from([
          ("idTree".to_owned(), id_tree_attribute_info),
