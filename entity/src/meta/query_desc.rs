...
pub fn get_query_desc() ->  EntityDesc {
    let entity_info = EntityInfo {
        name: "Query".to_owned(),
        display_name: "查询模板".to_owned(),
        class_name: "Query".to_owned(),
        table_name: "ui_query".to_owned(),
        base_path: "entity::query".to_owned(),
    };
    let id_query_attribute_info = AttributeInfo {
        column_name: "id_query".to_owned(),
        name: "idQuery".to_owned(),
        display_name: "查询模板id".to_owned(),
    ...
    let entity_desc = EntityDesc {
      ...
      pk_attribute_info: id_query_attribute_info.clone(),
      ...
      attribute_info_map: HashMap::from([
          ("idQuery".to_owned(), id_query_attribute_info),
