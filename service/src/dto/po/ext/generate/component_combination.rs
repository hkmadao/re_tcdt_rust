...
pub struct EntityInfoPO {
    ...
    /// 基础路径
    #[serde(default)]
    pub real_base_path: Option<String>,
    /// 模块名称
    #[serde(default)]
    ...
    /// 外键agg属性信息
    #[serde(default)]
    pub agg_fk_attribute_info_list: Vec<AttributeInfoPO>,
    /// 引用agg类型属性信息
    #[serde(default)]
    pub agg_up_attribute_info_list: Vec<AttributeInfoPO>,
    /// 引用aggSingle类型属性信息
    #[serde(default)]
    pub agg_up_single_attribute_info_list: Vec<AttributeInfoPO>,
    /// 下级agg属性信息
    #[serde(default)]
    pub agg_down_attribute_info_list: Vec<AttributeInfoPO>,
    /// 下级aggSingle属性信息
    #[serde(default)]
    pub agg_down_single_attribute_info_list: Vec<AttributeInfoPO>,
    /// 基础数据引用包
    #[serde(default)]
    pub out_base_package_list: Vec<BasePackageInfo>,
    /// 上级直接引用的外部实体
